...
from . import plot_progresses, plot_archives, plot_visualisations
...
def launch_plots(exp_path, 
    ...
    if archive:
        print("\nPlotting archives.")
        plot_archives.plot_archive("archive_", exp_path, save_path, env_names, \
                                   algo_names, max_evals, min_fit, max_fit, verbose = verbose)
    ...
    if progress: 
    	...
    	if variation:
    	    ...
    	    variation_variants = data[data["Algorithm"].str.contains("PGA-MAP-Elites")]["Algorithm"].drop_duplicates().values
    ...
    if visualisation:
    	...
    	data = plot_visualisations.plot_visualisation(data_path=exp_path, 
                                                      save_path=save_path,
                                                      variant_names=algo_names,
                                                      env_names=env_names,
