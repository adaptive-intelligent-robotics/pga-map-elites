...
def plot_cvt_map(archive_file, centroids_file, save_path, case_name, \
    ...
    # Fitness range
    verbose and print("Average fit : ", fit.sum() / fit.shape[0], " --- Total len : ", len(fit))
...
def plot_cvt(ax, centroids, fit, desc, norm, colormap=my_cmap):
    """
