...
def read_input():
    ...
    assert not (
        args.algo == "PGA-MAP-Elites"
        and args.proportion_evo == 1
        and args.proportion_update == 1
        and args.exclude_greedy_actor
    ...
    if args.algo == "Deep-grid":
        ...
        if args.exclude_greedy_actor:
            args.algo_type += "_wo_greedy"
    if args.best_greedy_actor:
        args.algo_type += "_best_greedy"
    ...
    if args.algo != "PGA-MAP-Elites" and args.crossover_op == "iso_dd":
        args.algo_type += "-line"
    if args.iso_sigma != 0.005 and args.crossover_op == "iso_dd":
        args.algo_type += "_iso" + str(args.iso_sigma)
    if args.line_sigma != 0.05 and args.crossover_op == "iso_dd":
        args.algo_type += "_line" + str(args.line_sigma)
...
if __name__ == "__main__":
    ...
    (
        ...
        args.file_name,
        args.save_path,
        args.exclude_greedy_actor,
        args.best_greedy_actor,
    )
